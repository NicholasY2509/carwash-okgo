    ...
    <div class="receipt-container">
        ...
        <div class="meta-grid">
            <div class="meta-row">
                ...
                <div class="meta-value" style="font-family: 'Courier New', Courier, monospace;">#{{ $transaction_id }}
                </div>
            </div>
            <div class="meta-row">
                <div class="meta-label">Tanggal</div>
                <div class="meta-value" style="font-family: 'Courier New', Courier, monospace;">{{ $transaction_date }}
                </div>
            </div>
            <div class="meta-row">
        ...
        <div class="meta-grid">
            <div class="meta-row">
                ...
                <div class="meta-value" style="font-family: 'Courier New', Courier, monospace;">{{ $customer_name }}
                </div>
            </div>
            <div class="meta-row">
        ...
        <div class="total-section">
            ...
            <div class="total-row">
                ...
                <div class="total-value" style="font-family: 'Courier New', Courier, monospace;">{{ $payment_method }}
                </div>
            </div>
            ...
            @if($payment_method === 'Voucher' && !empty($voucher_serial_number))
                <div class="total-row">
                    ...
                    <div class="total-value" style="font-family: 'Courier New', Courier, monospace;">
                        {{ $voucher_serial_number }}</div>
                </div>
                @if(isset($remaining_vouchers))
                    <div class="total-row">
                        <div class="total-label">Sisa Voucher</div>
                        <div class="total-value" style="font-family: 'Courier New', Courier, monospace;">
                            {{ $remaining_vouchers }}</div>
                    </div>
                @endif
            @endif

            <div class="total-row">
                <div class="total-label grand-total" style="font-family: 'Courier New', Courier, monospace;">Grand Total
                </div>
