...
function CarWashIndex() {
  ...
  var _a = react_2.useState(pagination.per_page || 10),
      perPage = _a[0],
      setPerPage = _a[1];
  ...
  var columns = [{
    ...
    cell: function cell(_a) {
      ...
      var handlePrint = function handlePrint() {
        ...
        var transaction = row.original; // Helper functions for formatting (same as receipt-formatter.ts)

        var LINE_WIDTH = 48;

        var centerText = function centerText(text, width) {
          if (width === void 0) {
            width = LINE_WIDTH;
          }
        ...
        var leftRightText = function leftRightText(leftText, rightText, width) {
          if (width === void 0) {
            width = LINE_WIDTH;
          }
        ...
        var drawLine = function drawLine(_char, width) {
          if (_char === void 0) {
            _char = "=";
          }
      ...
      return React.createElement(button_1.Button, {
        ...
        title: "Cetak Struk"
      }, React.createElement(lucide_react_1.Printer, {
        className: "h-4 w-4"
      }));
    }
  }];
  ...
  var handlePageChange = function handlePageChange(page) {
    react_1.router.get(route("car-washes.index"), {
      page: page,
      per_page: perPage,
  ...
  var handlePerPageChange = function handlePerPageChange(newPerPage) {
  ...
  return React.createElement(app_layout_1["default"], {
    breadcrumbs: breadcrumbs
  }, React.createElement(react_1.Head, {
    title: "Car Wash"
  ...
  }, "Halaman ", pagination.current_page, " dari", " ", pagination.last_page), React.createElement(button_1.Button, {
    variant: "outline",
    size: "sm",
    ...
    className: "text-sm"
  }, "Baris per halaman:"), React.createElement(dropdown_menu_1.DropdownMenu, null, React.createElement(dropdown_menu_1.DropdownMenuTrigger, {
    asChild: true
  }, React.createElement(button_1.Button, {
    variant: "outline",
    size: "sm",
    className: "min-w-[60px] justify-between"
  }, perPage)), React.createElement(dropdown_menu_1.DropdownMenuContent, {
    align: "end"
  }, [5, 10, 20, 50, 100].map(function (size) {
    return React.createElement(dropdown_menu_1.DropdownMenuItem, {
      key: size,
  ...
  }), searchQuery && React.createElement(button_1.Button, {
    variant: "ghost",
    size: "sm",
    onClick: clearSearch,
    ...
    className: "h-4 w-4"
  })))))), React.createElement("div", null, React.createElement(data_table_1.DataTable, {
    columns: columns,
