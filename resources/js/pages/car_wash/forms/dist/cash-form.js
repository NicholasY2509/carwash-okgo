...
var car_plate_search_1 = require("./car-plate-search");
var CreateCashPurchase = react_2.forwardRef(function (_a, ref) {
    ...
    var _p = react_2.useState({}), localErrors = _p[0], setLocalErrors = _p[1];
    var handleSubmit = function (footerData) {
        // Validation: car_id or car_plate_number must not be null/empty
        if (!data.car_id && !data.car_plate_number) {
            setLocalErrors({
                car_plate_number: "Nomor polisi harus diisi atau pilih mobil terdaftar."
            });
            return;
        }
        setLocalErrors({});
        setFormLoading(true);
        var finalData = __assign(__assign({}, data), { stall_id: footerData.stall_id, product_id: footerData.product_id, payment_method: footerData.payment_method || null, nominal_bayar: footerData.nominal_bayar || null });
        react_1.router.post(route("car-washes.store"), finalData, {
    ...
    return (react_2["default"].createElement("form", { onSubmit: function (e) { return e.preventDefault(); }, className: "relative px-4" },
        formLoading && (react_2["default"].createElement("div", { className: "absolute inset-0 z-20 flex items-center justify-center" },
            ...
            react_2["default"].createElement("div", { className: "flex flex-col lg:flex-row gap-2" },
                ...
                react_2["default"].createElement("div", { className: "border rounded-lg p-4" },
                    ...
                    selectedCustomer &&
                        ...
                        react_2["default"].createElement(select_1.Select, { onValueChange: handleCarSelect, value: data.car_id || "", disabled: !!carPlateSearch },
                    ...
                    react_2["default"].createElement("div", { className: "flex flex-col gap-2 lg:flex-row" },
                        react_2["default"].createElement("div", { className: "w-full lg:w-2/5" },
                            ...
                            (errors.car_plate_number ||
                                localErrors.car_plate_number) && (react_2["default"].createElement("p", { className: "text-sm text-red-600" }, errors.car_plate_number ||
                        ...
                        react_2["default"].createElement("div", { className: "w-full lg:w-3/5" },
                            ...
                            react_2["default"].createElement(input_1.Input, { id: "car_color", value: data.car_color, onChange: function (e) {
                                ...
                                }, disabled: !!carPlateSearch && !!selectedCustomer }),
...
exports["default"] = CreateCashPurchase;
