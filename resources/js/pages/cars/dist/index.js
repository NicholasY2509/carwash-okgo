...
function CustomerIndex() {
    ...
    var cars = props.cars.data;
    var pagination = props.cars;
    ...
    var handlePageChange = function (page) {
        react_1.router.get(route("cars.index"), { page: page, per_page: perPage, search: debouncedSearchQuery }, { preserveState: true });
    };
    var handlePerPageChange = function (newPerPage) {
        setPerPage(newPerPage);
        react_1.router.get(route("cars.index"), { page: 1, per_page: newPerPage, search: debouncedSearchQuery }, { preserveState: true });
    };
    react_2.useEffect(function () {
        react_1.router.get(route("cars.index"), { page: 1, per_page: perPage, search: debouncedSearchQuery }, { preserveState: true });
    ...
    var columns = [
        ...
        { accessorKey: "customer.name", header: "Customer" },
        {
            accessorKey: "actions",
            header: "Actions",
            cell: function (info) { return (React.createElement(button_1.Button, { size: "icon", variant: "outline", onClick: function () {
                    var carId = info.row.original.id;
                    react_1.router.visit(route("cars.show", carId));
                } },
    ...
    return (React.createElement(app_layout_1["default"], { breadcrumbs: breadcrumbs },
        ...
        React.createElement("div", { className: "flex h-full flex-1 flex-col gap-4 rounded-xl p-4" },
            React.createElement("div", { className: "flex justify-between" },
                React.createElement(heading_1["default"], { title: "Daftar Mobil Customers", description: "Lihat daftar mobil." })),
            React.createElement("div", { className: "flex flex-col gap-2" },
                React.createElement("div", { className: "flex justify-between flex-row" },
                    ...
                    React.createElement("div", { className: "flex flex-row items-center gap-2" },
                        ...
                        React.createElement("div", { className: "relative flex-1 max-w-md" },
                            ...
                            React.createElement(input_1.Input, { placeholder: "Cari plat/model/warna/customer...", value: searchQuery, onChange: function (e) { return setSearchQuery(e.target.value); }, className: "pl-10 pr-10" }),
                ...
                React.createElement(data_table_1.DataTable, { columns: columns, data: cars, getRowId: function (row) { var _a; return (_a = row.id) === null || _a === void 0 ? void 0 : _a.toString(); } }),
