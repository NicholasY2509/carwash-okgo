...
import StaffIncentiveTierForm from "./forms/incentive-tier-form";
import {
    AlertDialogHeader,
    AlertDialogFooter,
    AlertDialog,
...
export default function StaffIncentiveTiersIndex() {
    ...
    const [selectedTier, setSelectedTier] = useState<StaffIncentiveTier | null>(null);

    const breadcrumbs: BreadcrumbItem[] = [
        { title: "Settings", href: "/settings/profile" },
        { title: "Master Tier Insentif Staff", href: "/settings/staff-incentive-tiers" },
    ];

    const columns: ColumnDef<StaffIncentiveTier>[] = [
        {
            id: "index",
            header: "No",
    ...
    function handleDelete(id: number) {
        router.delete(route("staff-incentive-tiers.destroy", id), {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Master Tier Insentif Staff" />
